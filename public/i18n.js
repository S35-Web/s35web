    ...
    const STRINGS = {
        en: {
            meta: {
                ...
                mlHomeTitle: 'Laboratorio — Materials Research & Development | S-35',
                ...
                mlMaterialsTitle: 'Material Index — Laboratorio | S-35',
                mlMaterialsDescription: 'Index of documented and in-study raw materials at Laboratorio, S-35’s materials research division.',
                mlResearchTitle: 'Research Index — Laboratorio | S-35',
                mlResearchDescription: 'Index of Laboratorio research on aggregates, fillers and binders.',
                mlMethodologyTitle: 'Methodology — Laboratorio | S-35',
                mlMethodologyDescription: 'How Laboratorio characterises raw materials: a fixed process of source, sample, classification, measurement and documentation before any formulation.',
            ...
            ml: {
                ...
                manifestoP2: 'Laboratorio is S-35’s research archive for studying those variables, documenting them and turning that knowledge into better materials.',
                ...
                methodologyLede: 'Laboratorio uses a progressive method to characterise raw materials before they enter formulated systems.',
                ...
                disclaimer: 'Raw-material characterisation data published in Laboratorio is for information and technical disclosure. It is not a product specification, technical data sheet or performance warranty for any S-35 product.',
                ...
                chartY: '% PASSING',
                aboutLabel: 'WHAT LABORATORIO IS — AND WHAT IT IS NOT',
                aboutTitle: 'What Laboratorio is — and what it is not',
                aboutWhat: 'What it is',
                aboutWhatP: 'Laboratorio is an open raw-material characterisation archive built by S-35. It publishes what is observed and measured on minerals, aggregates, binders and fillers <em>before</em> they become a product.',
                aboutWhatP2: 'The study is of the material itself, not of a supplier: what is documented is the specification the raw material must meet to enter a formulation. That is why the reference remains valid when the supply changes.',
                aboutNot: 'What it is not',
                aboutNotP: 'This division is not an accredited laboratory. It is not a certification body. It is not a product-specification source. Characterisation data <strong>does not constitute a technical specification or a performance warranty</strong> for any S-35 product: each commercial product has its own technical file.',
                aboutHow: 'How data is obtained',
                aboutHowP: 'Every publishable value carries a provenance label. If a number has no provenance, the archive does not publish it. Anyone reading a file always knows whether they are looking at an in-house measurement, a normative reference or an observation.',
                aboutChain1: 'Knowledge of the material',
                aboutChain2: 'Own technical criterion',
                aboutChain3: 'Formulation and development',
                aboutChain4: 'Commercial product',
                aboutOrder: 'The order is deliberate. Never the other way around: a product does not define what the material can do.',
                aboutPubH: 'What it publishes',
                aboutPubP: 'What is known about the raw material: properties, standard ranges, observed behaviour and handling notes.',
                aboutHideH: 'What it does not publish',
                aboutHideP: 'What S-35 does with it: dosages, production target curves or suppliers.',
                aboutMeasT: 'Measured by S-35',
                aboutMeas: 'In-house test on an identified sample, with method and date.',
                aboutRefT: 'Documentary reference',
                aboutRef: 'Taken from a standard, literature or a supplier sheet, always with a source.',
                aboutObsT: 'Internal observation',
                aboutObs: 'Direct uninstrumented finding: colour, texture, visible behaviour.',
                aboutHypT: 'Working hypothesis',
                aboutHyp: 'An assumption that guides a test in preparation, marked until it is confirmed.',
                aboutWipT: 'Test in progress',
                aboutWip: 'Work started with no conclusion. The table reads “not yet measured”.',
                ...
                aboutPublishes: 'Laboratorio publishes <em>what is known about the raw material</em>. It does not publish what S-35 does with it: no dosages, no production target curves, no suppliers.',
                aboutRead: 'How to read a file',
                aboutRead1t: 'Typical profile first',
                aboutRead1p: 'The file starts with typical standard or trade profiles, labelled REF, and a visual reference of the material.',
                aboutRead2t: 'Measurement later',
                aboutRead2p: 'As in-house tests are run, those values become MEAS with their method and date. The file gains precision over time.',
                aboutRead3t: 'An empty field is intentional',
                aboutRead3p: 'Where a lot has not been tested, the figure does not appear. It is not filled in by estimate or by analogy with another material.',
                aboutRead4t: 'Visible revision',
                aboutRead4p: 'Each file shows its revision number. The archive is corrected and expanded in public, without rewriting the history.',
                methodLabel: 'METHODOLOGY',
                methodTitle: 'Methodology',
                methodKicker: 'Laboratorio · Open archive',
                methodLede: 'No material enters a formulation without first going through a fixed characterisation process. The study is of the material itself and of what its standards require, so the reference remains valid even if the supplier changes. That prior work — measure, test, adjust, measure again — is what sustains the performance of every product that goes to market.',
                ...
                methodKpiSteps: 'process steps',
                methodKpiMats: 'documented materials',
                methodKpiNorms: 'reference standards',
                methodKpiUpdated: 'last update',
                methodSecProcess: 'The process',
                methodSecStudy: 'What is studied',
                methodStudyLede: 'The object of study is the material itself, not who supplies it. Lime, gypsum or sand must meet what their standards require: the archive documents that expected behaviour and checks that the raw material entering the plant meets it.',
                methodStudyMat: 'The material',
                methodStudyMatP: 'Each file describes the material family and the ranges its standard sets: composition, particle size, behaviour with water, limits of use.',
                methodStudySup: 'The supply',
                methodStudySupP: 'A supplier can change for availability, logistics or cost. What does not change is the specification the material must meet before it enters a formulation: it is always checked against the same reference.',
                methodSecBefore: 'Research before product',
                methodBeforeLede: 'Behind every catalogue product there are months of prior work on its raw materials. That study is the part that is not seen, and it is the part that determines the result.',
                methodBeforeStudy: 'What is studied',
                methodBeforeStudyP: 'Every aggregate and raw material — sand, lime, gypsum, cement, bentonite, marble dust — is characterised in depth: composition, behaviour with water, particle size, compatibilities and limits.',
                methodBeforeCat: 'What reaches the catalogue',
                methodBeforeCatP: 'Only formulations that have already been tested, adjusted and validated. A product goes to market when its performance is repeatable, not when the mix works once.',
                methodBeforeClose: 'Knowing each raw material in depth is what makes it possible to anticipate how a mix will behave on site: how much water it asks for, how it sets, how it ages, what it tolerates and what it does not. That advantage is not improvised in production; it is built in the laboratory, long before the product exists.',
                methodSecMeasure: 'How it is measured',
                methodMeas1t: 'Standard before internal criterion.',
                methodMeas1p: 'When a recognised method exists (ASTM, API, NOM), that method is followed and cited. Internal criterion is used only where no applicable standard exists, and it is marked as such.',
                methodMeas2t: 'Date and traceability.',
                methodMeas2p: 'Each measurement is tied to a date and to a sample or experiment code. A figure without a date does not enter the file.',
                methodMeas3t: 'In-house or external laboratory.',
                methodMeas3p: 'Routine tests are run in-plant; tests that need specialised equipment go to an external laboratory, always identified by name on the file.',
                methodMeas4t: 'Measured data, not estimated.',
                methodMeas4p: 'A value is published when the measurement that supports it exists. Nothing is filled in by approximation or by analogy with another material.',
                methodSecCycle: 'Where continuous improvement comes from',
                methodCycle1t: 'Analysis',
                methodCycle1p: 'Each material is measured before it is used. Composition, behaviour and limits are recorded, not assumed.',
                methodCycle2t: 'Experimentation',
                methodCycle2p: 'Formulations are tested before they go into production. What has not been tested is not claimed.',
                methodCycle3t: 'Constant study',
                methodCycle3p: 'The archive is reviewed and updated continuously: a documented material remains under observation.',
                methodCycleClose: 'This cycle — analyse, experiment, document, review again — is what backs every technical file in the catalogue. A product does not reach a final formula by intuition: it gets there because its raw material was characterised, its mixes were tested and its results were recorded with the same method on every lot.',
                methodSecSite: 'What this means on site',
                methodSite1t: 'Consistency between lots',
                methodSite1p: 'Raw materials are checked lot by lot. A bag behaves like the previous one, in colour, yield and working time.',
                methodSite2t: 'Predictable behaviour',
                methodSite2p: 'Water dosage, set and finish are measured, not approximated. The applicator knows what to expect before mixing.',
                methodSite3t: 'Technical backing',
                methodSite3p: 'When a site question arises there is a record to go back to: which material, which test, which date. Answers come from data.',
                methodSecTrust: 'Transparency commitment',
                methodTrustP: 'Each file clearly distinguishes a measured value, a direct observation and a normative reference. When a test is run in an external laboratory, it is identified as such. That is the only way the data can be used to decide, and not merely to illustrate.',
                methodEnd: 'Materials Research Division · S-35® · Culiacán, Sinaloa, Mexico. The archive expands continuously.',
                step1: 'SOURCE',
                step1p: 'The material and the standard that applies to it are identified, not a particular supplier.',
                step2: 'SAMPLE',
                step2p: 'It is recorded with a code (ML-SMP) and a visual reference of its typical appearance.',
                step3: 'CLASSIFY',
                step3p: 'A category (AGG, BND, FIL…) and a sequential code are assigned. Codes are never reused.',
                step4: 'MEASURE',
                step4p: 'Instrumented tests with a standard, method and date. Each value is traceable to its sample.',
                step5: 'TEST',
                step5p: 'Mixes and variants are tried on one or more samples (ML-EXP) until the material’s limits are found.',
                step6: 'FORMULATE',
                step6p: 'What was learned decides what to combine, in what proportion and with what tolerance.',
                step7: 'VALIDATE',
                step7p: 'Internal review of results: performance must repeat before it is accepted.',
                step8: 'DOCUMENT',
                step8p: 'A public file with the normative reference, revision and notes. The archive updates in public.',
                ...
                ftBrand: 'LABORATORIO · S-35® · CHARACTERISATION ARCHIVE',
        ...
        es: {
            meta: {
                ...
                mlHomeTitle: 'Laboratorio — Investigación y desarrollo de materiales | S-35',
                ...
                mlMaterialsTitle: 'Índice de materiales — Laboratorio | S-35',
                mlMaterialsDescription: 'Índice de materias primas documentadas y en estudio en Laboratorio, la división de investigación de materiales de S-35.',
                mlResearchTitle: 'Índice de investigación — Laboratorio | S-35',
                mlResearchDescription: 'Índice de investigaciones de Laboratorio sobre agregados, cargas y cementantes.',
                mlMethodologyTitle: 'Metodología — Laboratorio | S-35',
                mlMethodologyDescription: 'Cómo Laboratorio caracteriza materias primas: un proceso fijo de origen, muestra, clasificación, medición y documentación, antes de cualquier formulación.',
            ...
            ml: {
                ...
                manifestoP2: 'Laboratorio es el archivo de investigación de S-35 dedicado a estudiar estas variables, documentarlas y convertir ese conocimiento en mejores materiales.',
                ...
                methodologyLede: 'Laboratorio utiliza una metodología progresiva para caracterizar materias primas antes de evaluar su incorporación a sistemas formulados.',
                ...
                disclaimer: 'Los datos de caracterización de materias primas publicados en Laboratorio tienen fines informativos y de divulgación técnica. No constituyen especificación de producto, ficha técnica ni garantía de desempeño de ningún producto S-35.',
                ...
                chartY: '% QUE PASA',
                aboutLabel: 'QUÉ ES LABORATORIO — Y QUÉ NO ES',
                aboutTitle: 'Qué es Laboratorio — y qué no es',
                aboutWhat: 'Qué es',
                aboutWhatP: 'Laboratorio es un archivo abierto de caracterización de materias primas desarrollado por S-35. Publica lo que se observa y se mide sobre minerales, agregados, cementantes y cargas <em>antes</em> de convertirlos en un producto.',
                aboutWhatP2: 'El estudio es del material en sí, no de un proveedor: lo que se documenta es la especificación que la materia prima debe cumplir para entrar a una formulación. Por eso la referencia sigue siendo válida cuando cambia el suministro.',
                aboutNot: 'Qué no es',
                aboutNotP: 'Esta división no es un laboratorio acreditado. No es un organismo de certificación. No es una fuente de especificación de producto. Los datos de caracterización <strong>no constituyen especificación técnica ni garantía de desempeño</strong> de ningún producto S-35: cada producto comercial tiene su propia ficha técnica.',
                aboutHow: 'Cómo se obtienen los datos',
                aboutHowP: 'Cada valor publicable lleva una etiqueta de procedencia. Si un número no tiene procedencia, el archivo no lo publica. Quien lee una ficha sabe siempre si está viendo una medición propia, una referencia normativa o una observación.',
                aboutChain1: 'Conocimiento del material',
                aboutChain2: 'Criterio técnico propio',
                aboutChain3: 'Formulación y desarrollo',
                aboutChain4: 'Producto comercial',
                aboutOrder: 'El orden es deliberado. Nunca al revés: un producto no define lo que el material puede hacer.',
                aboutPubH: 'Qué publica',
                aboutPubP: 'Lo que se sabe de la materia prima: propiedades, rangos normativos, comportamiento observado y notas de manejo.',
                aboutHideH: 'Qué no publica',
                aboutHideP: 'Lo que S-35 hace con ella: dosificaciones, curvas objetivo de producción ni proveedores.',
                aboutMeasT: 'Medido por S-35',
                aboutMeas: 'Ensayo propio sobre una muestra identificada, con método y fecha.',
                aboutRefT: 'Referencia documental',
                aboutRef: 'Tomado de norma, bibliografía o ficha de proveedor, siempre con fuente.',
                aboutObsT: 'Observación interna',
                aboutObs: 'Constatación directa no instrumentada: color, textura, comportamiento visible.',
                aboutHypT: 'Hipótesis de trabajo',
                aboutHyp: 'Supuesto que orienta un ensayo en preparación, marcado hasta confirmarse.',
                aboutWipT: 'Ensayo en curso',
                aboutWip: 'Trabajo iniciado sin conclusión. En tabla se lee “aún no medido”.',
                ...
                aboutPublishes: 'Laboratorio publica <em>qué se sabe sobre la materia prima</em>. No publica qué hace S-35 con ella: ni dosificaciones, ni curvas objetivo de producción, ni proveedores.',
                aboutRead: 'Cómo leer una ficha',
                aboutRead1t: 'Perfil típico primero',
                aboutRead1p: 'La ficha nace con los perfiles típicos de norma o de comercio, etiquetados REF, y una referencia visual del material.',
                aboutRead2t: 'Medición después',
                aboutRead2p: 'A medida que se corren ensayos propios, esos valores pasan a MEAS con su método y fecha. La ficha gana precisión con el tiempo.',
                aboutRead3t: 'Campo vacío es intencional',
                aboutRead3p: 'Donde un lote no se ha ensayado, el dato no aparece. No se rellena por estimación ni por analogía con otro material.',
                aboutRead4t: 'Revisión visible',
                aboutRead4p: 'Cada ficha indica su número de revisión. El archivo se corrige y se amplía a la vista, sin reescribir el historial.',
                methodLabel: 'METODOLOGÍA',
                methodTitle: 'Metodología',
                methodKicker: 'Laboratorio · Archivo abierto',
                methodLede: 'Ningún material entra a una formulación sin antes pasar por un proceso fijo de caracterización. El estudio es sobre el material mismo y sobre lo que su normativa le exige, de modo que la referencia sigue siendo válida aunque cambie el proveedor. Ese trabajo previo —medir, ensayar, ajustar, volver a medir— es lo que sostiene el desempeño de cada producto que sale al mercado.',
                ...
                methodKpiSteps: 'pasos del proceso',
                methodKpiMats: 'materiales documentados',
                methodKpiNorms: 'normas de referencia',
                methodKpiUpdated: 'última actualización',
                methodSecProcess: 'El proceso',
                methodSecStudy: 'Qué se estudia',
                methodStudyLede: 'El objeto de estudio es el material en sí, no quién lo suministra. La cal, el yeso o la arena tienen que cumplir con lo que su normativa les exige: el archivo documenta ese comportamiento esperado y verifica que la materia prima que entra a planta lo cumpla.',
                methodStudyMat: 'El material',
                methodStudyMatP: 'Cada ficha describe la familia del material y los rangos que su normativa establece: composición, granulometría, comportamiento con agua, límites de uso.',
                methodStudySup: 'El suministro',
                methodStudySupP: 'Un proveedor puede cambiar por disponibilidad, logística o costo. Lo que no cambia es la especificación que el material debe cumplir antes de entrar a una formulación: se verifica siempre contra la misma referencia.',
                methodSecBefore: 'Investigación antes de producto',
                methodBeforeLede: 'Detrás de cada producto del catálogo hay meses de trabajo previo sobre sus materias primas. Ese estudio es la parte que no se ve, y es la que determina el resultado.',
                methodBeforeStudy: 'Lo que se estudia',
                methodBeforeStudyP: 'Cada agregado y materia prima —arena, cal, yeso, cemento, bentonita, marmolina— se caracteriza a fondo: composición, comportamiento con agua, granulometría, compatibilidades y límites.',
                methodBeforeCat: 'Lo que llega al catálogo',
                methodBeforeCatP: 'Solo formulaciones que ya pasaron por ensayo, ajuste y validación. Un producto sale al mercado cuando su desempeño es repetible, no cuando la mezcla funciona una vez.',
                methodBeforeClose: 'Conocer a fondo cada materia prima es lo que permite anticipar cómo se comportará una mezcla en obra: cuánta agua pide, cómo fragua, cómo envejece, qué tolera y qué no. Esa ventaja no se improvisa en producción; se construye en el laboratorio, mucho antes de que exista el producto.',
                methodSecMeasure: 'Cómo se mide',
                methodMeas1t: 'Norma antes que criterio propio.',
                methodMeas1p: 'Cuando existe un método reconocido (ASTM, API, NOM), se sigue ese método y se cita. El criterio interno solo se usa donde no hay norma aplicable, y se marca como tal.',
                methodMeas2t: 'Fecha y trazabilidad.',
                methodMeas2p: 'Cada medición queda ligada a una fecha y a un código de muestra o experimento. Un dato sin fecha no entra a la ficha.',
                methodMeas3t: 'Laboratorio propio o externo.',
                methodMeas3p: 'Ensayos sencillos y de rutina se corren en planta; ensayos que requieren equipo especializado se envían a laboratorio externo, siempre identificado por nombre en la ficha.',
                methodMeas4t: 'Dato medido, no estimado.',
                methodMeas4p: 'Un valor se publica cuando existe la medición que lo respalda. Nada se completa por aproximación ni por analogía con otro material.',
                methodSecCycle: 'De dónde sale la mejora continua',
                methodCycle1t: 'Análisis',
                methodCycle1p: 'Cada material se mide antes de usarse. Composición, comportamiento y límites quedan registrados, no supuestos.',
                methodCycle2t: 'Experimentación',
                methodCycle2p: 'Las formulaciones se prueban antes de salir a producción. Lo que no se ha ensayado no se afirma.',
                methodCycle3t: 'Estudio constante',
                methodCycle3p: 'El archivo se revisa y actualiza de forma continua: un material documentado sigue en observación.',
                methodCycleClose: 'Este ciclo —analizar, experimentar, documentar, volver a revisar— es lo que respalda cada ficha técnica del catálogo. Un producto no llega a fórmula final por intuición: llega porque su materia prima fue caracterizada, sus mezclas fueron probadas y sus resultados quedaron registrados con la misma metodología en cada lote.',
                methodSecSite: 'Lo que esto significa en obra',
                methodSite1t: 'Consistencia entre lotes',
                methodSite1p: 'Las materias primas se verifican lote a lote. Un saco se comporta como el anterior, en color, rendimiento y tiempo de trabajo.',
                methodSite2t: 'Comportamiento predecible',
                methodSite2p: 'Dosificación de agua, fraguado y acabado están medidos, no aproximados. El aplicador sabe qué esperar antes de mezclar.',
                methodSite3t: 'Respaldo técnico',
                methodSite3p: 'Ante una duda de obra existe un registro al cual volver: qué material, qué ensayo, qué fecha. Las respuestas salen de datos.',
                methodSecTrust: 'Compromiso de transparencia',
                methodTrustP: 'Cada ficha distingue con claridad entre un valor medido, una observación directa y una referencia normativa. Cuando un ensayo se realiza en laboratorio externo, se identifica como tal. Es la única manera de que los datos sirvan para decidir, y no solo para ilustrar.',
                methodEnd: 'División de Investigación de Materiales · S-35® · Culiacán, Sinaloa, México. El archivo se expande de forma continua.',
                step1: 'ORIGEN',
                step1p: 'Se identifica el material y la normativa que le aplica, no un proveedor en particular.',
                step2: 'MUESTRA',
                step2p: 'Se documenta con un código (ML-SMP) y una referencia visual de su presentación habitual.',
                step3: 'CLASIFICAR',
                step3p: 'Se asigna categoría (AGG, BND, FIL…) y código correlativo. El código nunca se reutiliza.',
                step4: 'MEDIR',
                step4p: 'Ensayos instrumentados con norma, método y fecha. Cada valor queda trazable a su muestra.',
                step5: 'ENSAYAR',
                step5p: 'Se prueban mezclas y variantes sobre una o más muestras (ML-EXP) hasta encontrar los límites del material.',
                step6: 'FORMULAR',
                step6p: 'Lo aprendido decide qué combinar, en qué proporción y con qué margen de tolerancia.',
                step7: 'VALIDAR',
                step7p: 'Revisión interna de resultados: el desempeño debe repetirse antes de darse por bueno.',
                step8: 'DOCUMENTAR',
                step8p: 'Ficha pública con referencia normativa, revisión y notas de uso. El archivo se actualiza a la vista.',
                chainMineral: 'MINERAL',
                ...
                ftBrand: 'LABORATORIO · S-35® · ARCHIVO DE CARACTERIZACIÓN',
