    ...
    const STRINGS = {
        en: {
            ...
            ml: {
                ...
                aboutObs: 'uninstrumented internal observation (sight, loupe, photograph).',
                aboutHyp: 'working hypothesis.',
                aboutWip: 'test started, no conclusion; the table reads NOT YET MEASURED.',
                aboutFirst: 'The first files combine real S-35 macrophotography with visual observations and typical standard or trade profiles, labelled REF. Where the lot was not tested, the field is empty on purpose.',
                ...
                methodClose: 'If a test was done in an outside lab, the lab is named or the text says “external laboratory”. That fact is never omitted to imply in-house capacity. This first publication has no instrumented lot tests: there is a real photograph, observation and a normative reference.',
                step1: 'SOURCE',
                step1p: 'The region of origin is declared. Quarry and supplier are not published.',
                step2: 'SAMPLE',
                step2p: 'A physical lot is received, identified (ML-SMP) and photographed.',
                step3: 'CLASSIFY',
        ...
        es: {
            ...
            ml: {
                ...
                aboutObs: 'observación interna no instrumentada (vista, lupa, fotografía).',
                aboutHyp: 'hipótesis de trabajo.',
                aboutWip: 'ensayo iniciado, sin conclusión; en la tabla se lee AÚN NO MEDIDO.',
                aboutFirst: 'Las primeras fichas combinan macrofotografía real de S-35 con observaciones visuales y perfiles típicos de norma o de comercio, etiquetados REF. Donde el lote no se ensayó, el campo está vacío a propósito.',
                ...
                methodClose: 'Si un ensayo se hizo en laboratorio externo, se nombra el laboratorio o se dice “laboratorio externo”. Nunca se omite para insinuar capacidad propia. En esta primera publicación no hay ensayos instrumentados de lote: hay fotografía real, observación y referencia normativa.',
                step1: 'ORIGEN',
                step1p: 'Se declara la región de origen. No se publica cantera ni proveedor.',
                step2: 'MUESTRA',
                step2p: 'Se recibe un lote físico, se identifica (ML-SMP) y se fotografía.',
                step3: 'CLASIFICAR',
