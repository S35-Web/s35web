    ...
    const STRINGS = {
        en: {
            meta: {
                ...
                mlMethodologyTitle: 'How materials are studied | S-35',
            ...
            ml: {
                ...
                materialsLede: 'MATERIALS DOCUMENTED. Laboratorio is an open archive of raw-material characterisation developed by S-35.',
                ...
                methodLede: 'No material enters a formulation without first going through a fixed characterisation process. That prior work — measure, test, adjust, measure again — is what sustains the performance of every product that goes to market.',
                ...
                methodProc1: 'Source',
                methodProc2: 'Sample',
                methodProc3: 'Classify',
                methodProc4: 'Measure',
                methodProc5: 'Test',
                methodProc6: 'Formulate',
                methodProc7: 'Validate',
                methodProc8: 'Document',
                ...
                methodStudySupP: 'A supplier can change for availability, logistics or cost. What does not change is the specification the material must meet before it enters a formulation.',
                ...
                methodBeforeStudyP: 'Every aggregate and raw material — sand, lime, gypsum, cement, bentonite, marble dust — is characterised in depth before it is considered for a mix.',
                methodBeforeCat: 'What reaches the catalogue',
                methodBeforeCatP: 'Only formulations that have already been tested, adjusted and validated. A product goes to market when its performance is repeatable.',
                methodBeforeClose: 'Knowing each raw material in depth makes it possible to anticipate how a mix will behave on site: how much water it asks for, how it sets, how it ages, what it tolerates and what it does not. That advantage is not improvised in production; it is built in the laboratory, long before the product exists.',
                ...
                methodMeas3p: 'Routine tests are run in-plant; those that need specialised equipment go to an external laboratory, always identified on the file.',
        ...
        es: {
            meta: {
                ...
                mlMethodologyTitle: 'Cómo se estudian los materiales | S-35',
            ...
            ml: {
                ...
                materialsLede: 'MATERIALES DOCUMENTADOS. Laboratorio es un archivo abierto de caracterización de materias primas desarrollado por S-35.',
                ...
                methodLede: 'Ningún material entra a una formulación sin antes pasar por un proceso fijo de caracterización. Ese trabajo previo —medir, ensayar, ajustar, volver a medir— es lo que sostiene el desempeño de cada producto que sale al mercado.',
                ...
                methodProc1: 'Origen',
                methodProc2: 'Muestra',
                methodProc3: 'Clasificar',
                methodProc4: 'Medir',
                methodProc5: 'Ensayar',
                methodProc6: 'Formular',
                methodProc7: 'Validar',
                methodProc8: 'Documentar',
                ...
                methodStudySupP: 'Un proveedor puede cambiar por disponibilidad, logística o costo. Lo que no cambia es la especificación que el material debe cumplir antes de entrar a una formulación.',
                ...
                methodBeforeStudyP: 'Cada agregado y materia prima —arena, cal, yeso, cemento, bentonita, marmolina— se caracteriza a fondo antes de considerarse para una mezcla.',
                methodBeforeCat: 'Lo que llega al catálogo',
                methodBeforeCatP: 'Solo formulaciones que ya pasaron por ensayo, ajuste y validación. Un producto sale al mercado cuando su desempeño es repetible.',
                methodBeforeClose: 'Conocer a fondo cada materia prima permite anticipar cómo se comportará una mezcla en obra: cuánta agua pide, cómo fragua, cómo envejece, qué tolera y qué no. Esa ventaja no se improvisa en producción; se construye en el laboratorio, mucho antes de que exista el producto.',
                ...
                methodMeas3p: 'Los ensayos de rutina se corren en planta; los que requieren equipo especializado se envían a laboratorio externo, siempre identificado en la ficha.',
