    ...
    const STRINGS = {
        en: {
            ...
            ml: {
                ...
                aboutWhatP: 'Laboratorio is an open raw-material characterisation archive built by S-35. It publishes what is observed and measured on minerals, aggregates, binders and fillers <em>before</em> they become a product. The order is deliberate: knowledge first, then authority, then brand, then product.',
                aboutNot: 'What it is not',
                aboutNotP: 'This division is not an accredited laboratory. It is not a certification body. It is not a product-specification source. Characterisation data <strong>does not constitute a technical specification or a performance warranty</strong> for any S-35 product.',
        ...
        es: {
            ...
            ml: {
                ...
                aboutWhat: 'Qué es',
                aboutWhatP: 'Laboratorio es un archivo abierto de caracterización de materias primas desarrollado por S-35. Publica lo que se observa y se mide sobre minerales, agregados, cementantes y cargas <em>antes</em> de convertirlos en un producto. El orden es deliberado: primero conocimiento, después autoridad, después marca, después producto.',
                aboutNot: 'Qué no es',
                aboutNotP: 'Esta división no es un laboratorio acreditado. No es un organismo de certificación. No es una fuente de especificación de producto. Los datos de caracterización <strong>no constituyen especificación técnica ni garantía de desempeño</strong> de ningún producto S-35.',
