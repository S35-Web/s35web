...
const DIR = '/Assets/overview/waxtard-gris';

module.exports = {
  kicker: 'Waxtard® S-35',
  headline: ['WAXTARD', 'GRIS'],
  registered: true,
  deck: 'Deja pasar el vapor. Detiene el agua. Un tono gris mineral estable, para acabados rústicos o contemporáneos que respiran.',
  ...
  hero: {
    theme: 'gray',
    src: DIR + '/hero.png',
    alt: 'Saco de Waxtard Gris, con el polvo de la fórmula en suspensión',
  },
  problem: {
    kicker: 'El problema',
    ...
    compare: {
      left: {
        ...
        alt: 'Fachada gris con pintura ampollada y manchas de salitre por un acabado sellado',
        label: 'Acabado sellado / estuco',
        note: 'Atrapa vapor, salitre y ampollas',
      },
      right: {
        src: DIR + '/problem-ok.png',
        alt: 'Acabado de Waxtard Gris limpio y uniforme junto a una ventana',
        label: 'Waxtard® Gris',
  ...
  flex: {
    ...
    image: {
      src: DIR + '/action.png',
      alt: 'Corte del acabado gris: el agua perla en la superficie y el vapor sale del muro',
    },
  },
  lab: {
    kicker: 'Formulación',
  ...
  apply: {
    ...
    image: {
      src: DIR + '/apply.png',
      alt: 'Aplicador extendiendo Waxtard Gris sobre block, con llana',
    },
  },
  performance: {
    kicker: 'Desempeño',
    title: 'Absorción de agua frente a un estuco convencional.',
    waxtard: 'Waxtard® Gris: absorción mínima y estable.',
  ...
  close: {
    image: {
      src: DIR + '/close.png',
      alt: 'Casa contemporánea con acabado gris mineral, al atardecer',
    },
