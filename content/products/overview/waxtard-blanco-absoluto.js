...
module.exports = {
  ...
  hero: {
    theme: 'light',
    src: DIR + '/hero.png',
    alt: 'Saco de Waxtard Blanco Absoluto, con el polvo de la fórmula en suspensión',
  },
  problem: {
    kicker: 'El problema',
    ...
    compare: {
      ...
      right: {
        ...
        alt: 'Acabado de Waxtard Blanco Absoluto limpio y uniforme junto a una ventana',
        label: 'Waxtard Blanco Absoluto',
  ...
  apply: {
    ...
    image: {
      src: DIR + '/apply.png',
      alt: 'Aplicador extendiendo Waxtard Blanco Absoluto sobre block, con llana',
    },
  },
  performance: {
    kicker: 'Desempeño',
    title: 'Absorción de agua frente a un estuco convencional.',
    waxtard: 'Waxtard Blanco Absoluto: absorción mínima y estable.',
  ...
  close: {
    image: {
      src: DIR + '/close.png',
      alt: 'Fachada contemporánea en Blanco Absoluto, con piscina y luz lateral',
    },
