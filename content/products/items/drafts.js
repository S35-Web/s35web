...
module.exports = [
  ...
  liquid({
    ...
    packAlt: 'Envase de Nanotech Sellador hidrofóbico S-35',
    ...
    lead: 'Sellador líquido de la línea Nanotech para reducir la absorción de agua en superficies minerales ya acabadas. Borrador interno.',
    identification: [
  ...
  liquid({
    ...
    packAlt: 'Envase de Sellador Premium para pintura S-35',
    ...
    lead: 'Sellador líquido para preparar muros antes de pintar: iguala absorción y mejora el anclaje de la pintura. Borrador interno.',
    identification: [
  ...
  liquid({
    ...
    packAlt: 'Envase de Adhesivo Darawell S-35',
    description: 'Adhesivo Darawell: adhesivo líquido vinílico S-35. Cubeta.',
    strip: ['Adhesivo líquido vinílico', 'Cubeta'],
    lead: 'Adhesivo líquido vinílico de la línea S-35 (Darawell). Se usa como adhesivo / ligante líquido según la ficha impresa. Borrador interno.',
    identification: [
  ...
  liquid({
    ...
    packAlt: 'Envase de Adhesivo Heavy Duty S-35',
    ...
    lead: 'Adhesivo líquido de alto desempeño. Borrador interno: confirmar sustratos y alcances con la ficha impresa.',
    identification: [
