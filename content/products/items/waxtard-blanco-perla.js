...
module.exports = {
  ...
  figures: {
    pack: {
      src: '/Assets/productos_background/WAXTARD-blanco-perla.png',
      alt: 'Saco de 25 kg de Waxtard Blanco Perla',
      label: 'Fig. B · presentación',
    },
    // Fig. A pendiente: el repositorio no tiene la fotografía del producto en
    // polvo. Al subirla basta con poner su ruta en `src` para que aparezca.
    powder: {
      src: null,
      alt: 'Waxtard Blanco Perla en polvo, con detalle de grano',
      ...
      tables: [
        {
          ...
          head: ['Familia', 'Aporta'],
          rows: [
            ['Agregados minerales calcáreos seleccionados', 'Cuerpo, blancura y textura del acabado.'],
        ...
        },
        {
          ...
          rows: [
            ...
            ['Acabado gris o desigual', 'Base blanco perla estable, lista para pintar o dejar aparente.'],
          ],
        },
      ],
    },
      ...
      rows: [
        {
          ...
          value: 'Polvo blanco perla · acabado mate',
          practical: 'Se puede dejar aparente o usar como base de pintura sin sellador previo.',
          method: 'Visual',
        },
        {
      ...
      chart: {
        ...
        series: [
          ...
          },
          {
            ...
            tone: 'accent',
            label: 'WAXTARD Blanco Perla: absorción mínima y estable.',
          },
        ],
